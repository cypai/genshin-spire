...
import genshinspire.patches.relics.BottledPlaceholderField;
import genshinspire.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static genshinspire.DefaultMod.makeRelicOutlinePath;
import static genshinspire.DefaultMod.makeRelicPath;
