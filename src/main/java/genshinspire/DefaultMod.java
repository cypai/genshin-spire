...
import genshinspire.cards.*;
import genshinspire.characters.TheDefault;
import genshinspire.events.IdentityCrisisEvent;
import genshinspire.potions.PlaceholderPotion;
import genshinspire.relics.BottledPlaceholderRelic;
import genshinspire.relics.DefaultClickableRelic;
import genshinspire.relics.PlaceholderRelic;
import genshinspire.relics.PlaceholderRelic2;
import genshinspire.util.IDCheckDontTouchPls;
import genshinspire.util.TextureLoader;
import genshinspire.variables.DefaultCustomVariable;
import genshinspire.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "genshinspireResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "genshinspireResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "genshinspireResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "genshinspireResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "genshinspireResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "genshinspireResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "genshinspireResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "genshinspireResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "genshinspireResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "genshinspireResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "genshinspireResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "genshinspireResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "genshinspireResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "genshinspireResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "genshinspireResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "genshinspireResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "genshinspireResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("genshinspire") // ${project.artifactId}
